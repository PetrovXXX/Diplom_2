...
class TestLogin:
    ...
    @allure.title('Проверка логина с не правильным и паролем')
    @allure.description('При логине передаются правильный email и не правильный password уже созданного пользователя')
    ...
    @allure.title('Проверка логина не существующего пользователя')
    @allure.description('При логине передаются не существующие email и password')
